    ...
    return (
        <div ref={listRef} className='list-container'>
            {vehicles.map((vehicle, index) => {
                return (
                    <VehiclesListItem scrollToVehicle={scrollToVehicle} index={index} key={vehicle.vehicle_id} vehicle={vehicle} onClick={setChosenVehicle} chosen={vehicle.vehicle_id === chosenVehicle.vehicle_id} />
                )
            })}
        </div>
    )
